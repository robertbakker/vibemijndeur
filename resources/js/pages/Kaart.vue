        ...
        <main class="relative flex flex-1 overflow-hidden">
            ...
            >
                <div class="p-stack-md border-outline-variant border-b">
                    ...
                    <form class="mt-stack-md relative" @submit.prevent="submitSearch">
                        <input
                            v-model="searchInput"
                            type="text"
                ...
                >
                    ...
                    >
                        ...
                        <p class="font-body-md text-body-md text-on-surface">
                            <span class="text-primary font-bold">{{ total.toLocaleString('nl-NL') }}</span>
                            werkzaamheden in dit gebied.
                        </p>
                        <p class="font-caption text-caption text-on-surface-variant mt-1">
                            Versleep of zoom de kaart om het gebied aan te passen.
                        </p>
                    </div>
                </nav>
            </aside>
            ...
            <section class="bg-surface-container-high relative flex-1">
                ...
                >
                    <p class="font-label-md text-label-md text-primary mb-stack-sm uppercase">
                        Op de kaart
                    </p>
                    <ul class="gap-stack-sm flex flex-col">
                        <li class="gap-stack-sm flex items-center">
                            <span class="bg-primary-container h-1 w-6 rounded-full"></span>
                            <span class="font-caption text-caption text-on-surface-variant">Werkzaamheden</span>
                        </li>
                        <li class="gap-stack-sm flex items-center">
                            <span class="bg-error h-1 w-6 rounded-full"></span>
                            <span class="font-caption text-caption text-on-surface-variant">Afsluiting / werkvak</span>
                        </li>
                        <li class="gap-stack-sm flex items-center">
                            <span class="border-secondary w-6 border-t-2 border-dashed"></span>
                            <span class="font-caption text-caption text-on-surface-variant">Omleiding</span>
                        </li>
                    </ul>
                </div>
                ...
                >
                    <div class="p-stack-lg border-outline-variant flex items-start justify-between border-b">
                        <div>
                            <span
                            ...
                            >
                            <h3 class="font-headline-md text-headline-md text-primary mt-stack-xs">
                                {{ selected.title }}
                            </h3>
                        </div>
                        <button
                    ...
                    <div class="p-stack-lg flex-1 space-y-stack-md overflow-y-auto">
                        <div class="border-outline-variant flex justify-between border-b pb-2">
                            <span class="font-label-md text-label-md text-on-surface-variant">Wegbeheerder</span>
                            <span class="font-label-md text-label-md text-primary">{{ selected.authority ?? '—' }}</span>
                        </div>
                        <div class="border-outline-variant flex justify-between border-b pb-2">
                            <span class="font-label-md text-label-md text-on-surface-variant">Status</span>
                            <span class="text-secondary font-label-md flex items-center gap-1 font-bold">
                                <span class="h-2 w-2 rounded-full" :class="severityColor(selected.severity)"></span>
